...
def test_the_admin_menu_lists_mentors_and_marks_the_one_open(app, admin_client, mentor):
    ...
    assert 'id="nav-children-mentors"' in account
    ...
    assert _current(read_only) == [f"/admin/users/{mentor.id}"]
